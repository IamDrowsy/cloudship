...
It's desigend to work from the repl against many different orgs and supporst
...
[source,clojure]
----
include::{sourcedir}/cloudship/connection/props/spec.clj[lines=24..29]
----
...
(->props :org1:other) =>
; nothing is overwritten, but username/url are adjustet for the sandbox
    {:api-version "40.0",
     :base-username "my@username.de",
     :full :org1:other,
     :org "org1",
